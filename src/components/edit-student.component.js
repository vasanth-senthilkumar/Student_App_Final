...
export default class CreateStudent extends Component {
  ...
  componentDidMount() {
    axios.get(' https://fierce-dusk-60690.herokuapp.com/students/edit-student/' + this.props.match.params.id)
      .then(response => {
        this.setState({
  ...
  handleSubmitDetails = () => {
    ...
    if (name === '' || rollno === ''||dateOfBirth===''||level===''||section===''||gender===''||fatherName===''||motherName===''||address===''||contactNumber==='') {
      ...
      axios.put(' https://fierce-dusk-60690.herokuapp.com/students/update-student/' + this.props.match.params.id, data)
        .then((res) => {
          this.setState({
  ...
  render() {
    const { name, rollno,dateOfBirth, level, section, gender, fatherName, motherName, address, contactNumber, canDisplayView, isError, alertVariant, alertMsg } = this.state;
      ...
      <>
        {
          ...
          <br/>
              ...
              <Button variant="success" size="lg" block="block" onClick={this.handleSubmitDetails}>
                Update Student
              </Button>
            </Form>
          </div>
